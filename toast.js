jQuery(document).ready(function () {
  ...
  jQuery('.toast_cell').on("click", '.ktoast_close', function (e) {

    e.preventDefault();
    var parent = $(this).parent('.ktoast');
    parent.fadeOut("slow", function () { $(this).remove(); });
  });
});

function success_toast(text) {
    console.log("Suucess Toast");
    var r = `<div class="ktoast ktoast--green">
    <div class="ktoast_icon">
      <svg version="1.1" class="ktoast_svg" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="ktoast_content">
      <p class="ktoast_type">Success</p>
      <p class="ktoast_message">${text}</p>
    </div>
    <div class="ktoast_close">
  ...
  document.getElementsByClassName("toast_cell")[0].innerHTML = r;
}

function error_toast(text) {
  console.log("Error Toast");
  var r = `<div class="ktoast ktoast--yellow">
  <div class="ktoast_icon">
